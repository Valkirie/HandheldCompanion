...
public class PerformanceManager : Manager
{
    ...
    public override void Start()
    {
        ...
        if (processor.GetType() == typeof(IntelProcessor))
        {
            ...
            var HypervisorEnforcedCodeIntegrityEnabled = RegistryUtils.GetBoolean(
                @"SYSTEM\CurrentControlSet\Control\DeviceGuard\Scenarios\HypervisorEnforcedCodeIntegrity", "Enabled");
            var VulnerableDriverBlocklistEnable =
                RegistryUtils.GetBoolean(@"SYSTEM\CurrentControlSet\Control\CI\Config",
