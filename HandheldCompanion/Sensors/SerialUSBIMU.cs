...
public class SerialUSBIMU
{
    ...
    public SerialPlacement SensorPlacement = SerialPlacement.Top;
    public bool SensorUpsideDown;
    ...
    public void SetSensorPlacement(SerialPlacement SensorPlacement)
    {
        this.SensorPlacement = SensorPlacement;
    }

    public void SetSensorOrientation(bool isUpsideDown)
    {
        this.SensorPlacement = SensorPlacement;
        this.SensorUpsideDown = isUpsideDown;
    }
}