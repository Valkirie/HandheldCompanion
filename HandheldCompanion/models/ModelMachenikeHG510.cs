...
internal class ModelMachenikeHG510 : IModel
{
    ...
    private readonly Model3DGroup FN;
    private readonly Model3DGroup FrontAccent;
    private readonly Model3DGroup JoystickBaseRingLeft;
    private readonly Model3DGroup JoystickBaseRingRight;
    ...
    private readonly Model3DGroup LED5;
    private readonly Model3DGroup LED6;
    private readonly Model3DGroup LED7;
    private readonly Model3DGroup LED8;
    private readonly Model3DGroup LogoInner;
    private readonly Model3DGroup LogoMid;
    private readonly Model3DGroup LogoOuter;
    private readonly Model3DGroup Machenike;
    private readonly Model3DGroup Switch;
    private readonly Model3DGroup Turbo;
    private readonly Model3DGroup W1;
    private readonly Model3DGroup W2;
    ...
    public ModelMachenikeHG510() : base("MachenikeHG510")
    {
        ...
        foreach (Model3DGroup model3D in model3DGroup.Children)
        {
            ...
            if (model3D.Equals(FrontAccent) || model3D.Equals(Machenike) || model3D.Equals(LogoOuter) ||
                model3D.Equals(LogoMid))
            {
