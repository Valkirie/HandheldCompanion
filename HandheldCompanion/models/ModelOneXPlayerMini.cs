...
internal class ModelOneXPlayerMini : IModel
{
    ...
    private readonly Model3DGroup BackGrillShadow;
    private readonly Model3DGroup BackIcon;
    private readonly Model3DGroup BodyInternal;
    private readonly Model3DGroup LED;
    private readonly Model3DGroup LeftBaseRing;
    private readonly Model3DGroup MKBIcon;
    private readonly Model3DGroup RightBaseRing;
    private readonly Model3DGroup Screen;
    private readonly Model3DGroup SpeakerLeft;
    private readonly Model3DGroup SpeakerRight;
    private readonly Model3DGroup StartIcon;
    private readonly Model3DGroup TopGrill;
    private readonly Model3DGroup TurboIcon;
    ...
    public ModelOneXPlayerMini() : base("OneXPlayerMini")
    {
        ...
        foreach (Model3DGroup model3D in model3DGroup.Children)
        {
            ...
            if (model3D.Equals(SpeakerLeft) || model3D.Equals(SpeakerRight)
                                            ...
                                            || model3D.Equals(B1Letter) || model3D.Equals(B2Letter) ||
                                            model3D.Equals(B3Letter) || model3D.Equals(B4Letter)
               )
            {
