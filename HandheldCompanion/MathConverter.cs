...
///     ConverterParameter must contain an arithmetic expression over converter arguments. Operations supported are +, -, *
///     and /
///     Single argument of a value converter may referred as x, a, or {0}
///     Arguments of multi value converter may be referred as x,y,z,t (first-fourth argument), or a,b,c,d, or {0}, {1},
///     {2}, {3}, {4}, ...
    ...
    IValueConverter
{
        ...
        public decimal Eval(object[] args)
        {
            if (_index >= args.Length)
                throw new ArgumentException(string.Format(
                    "MathConverter: parameter index {0} is out of range. {1} parameter(s) supplied", _index,
                    args.Length));
    ...
    private class Parser
    {
        ...
        {
            if (pos >= text.Length || text[pos] != c) throw new ArgumentException("Expected '" + c + "'");
        ...
        {
            if (pos != text.Length) throw new ArgumentException("Unexpected character '" + text[pos] + "'");
        }
    }
}