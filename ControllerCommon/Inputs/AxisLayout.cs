...
public struct AxisLayout
{
    ...
    public static AxisLayout LeftThumb = new(AxisLayoutFlags.LeftStick, AxisFlags.LeftThumbX, AxisFlags.LeftThumbY);
    public static AxisLayout RightThumb = new(AxisLayoutFlags.RightStick, AxisFlags.RightThumbX, AxisFlags.RightThumbY);
