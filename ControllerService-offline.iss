...
Filename: "{app}\redist\ViGEmBus_1.18.367_x64_x86.exe";  Parameters: "/quiet /norestart"; Flags: runascurrentuser
Filename: "{app}\redist\HidHide_1.2.98_x64.exe";  Parameters: "/quiet /norestart"; Flags: runascurrentuser
